...
$(function(){
  ...
  */
  ...
  $.each(obj_test.Term, function(key, value){
    ...
    var def_url = obj_test.URI[key];
    $("ul").append('<li class="glossary-definition hidden" data-definition='+value+'><a href='+def_url+'>'+value+'</a>'+': '+an_def+'</li>');
